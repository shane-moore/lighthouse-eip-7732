...
impl<E: EthSpec> From<ExecutionPayloadGloas<E>> for JsonExecutionPayloadV6<E> {
...
impl<E: EthSpec> From<ExecutionPayload<E>> for JsonExecutionPayload<E> {
    fn from(execution_payload: ExecutionPayload<E>) -> Self {
        match execution_payload {
            ...
            ExecutionPayload::Gloas(payload) => JsonExecutionPayload::V6(payload.into()),
        }
    }
}
...
impl<E: EthSpec> From<JsonExecutionPayloadV6<E>> for ExecutionPayloadGloas<E> {
...
impl<E: EthSpec> From<JsonExecutionPayload<E>> for ExecutionPayload<E> {
    fn from(json_execution_payload: JsonExecutionPayload<E>) -> Self {
        match json_execution_payload {
            ...
            JsonExecutionPayload::V6(payload) => ExecutionPayload::Gloas(payload.into()),
        }
    }
}
